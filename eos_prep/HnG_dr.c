...
#define NDIV 4000                  /* number of output points */
...
double error,                 /* error in ratint (not used) */
       ...
       log_e_tab[4001],        /* log of energy density points in EOS file */
       log_p_tab[4001],        /* log of pressure points in EOS file */
...
/*******************************************************************/
double deriv_e(double logp[4001], double loge[4001], int i, int n_tab)
{
double d_temp;   
 switch(i) { 
